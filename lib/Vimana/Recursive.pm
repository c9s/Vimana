...
require Exporter;
@ISA = qw(Exporter);
@EXPORT_OK = qw(fcopy rcopy dircopy dircopy_files fmove rmove dirmove pathmk pathrm pathempty pathrmdir);
$VERSION = '0.38';
...
sub dircopy_files {
   ...
   return @copied;
   # return wantarray ? ($filen,$dirn,$level,\@copied) : \@copied;
}
